...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_reconfig_cpu_cpu.v \
  $QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_reconfig_cpu_cpu_debug_slave_sysclk.v \
  $QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_reconfig_cpu_cpu_debug_slave_tck.v \
  $QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_reconfig_cpu_cpu_debug_slave_wrapper.v \
  $QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_reconfig_cpu_cpu_test_bench.v \
  ...
  $QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_rsp_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/altpcied_sv_hwtcl.sv \
  $QSYS_SIMDIR/submodules/altpcierd_hip_rs.v \
  $QSYS_SIMDIR/submodules/altpcierd_tl_cfg_sample.v \
  $QSYS_SIMDIR/submodules/altpcierd_rx_ecrc_128_sim.v \
  $QSYS_SIMDIR/submodules/altpcierd_rx_ecrc_64_sim.v \
  $QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_128_sim.v \
  $QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_64_sim.v \
  $QSYS_SIMDIR/submodules/altpcierd_ast256_downstream.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_app_icm.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ast_msi.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ast_rx.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ast_rx_128.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ast_rx_64.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ast_tx.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ast_tx_128.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ast_tx_64.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_check_128.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_check_64.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_calc.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_ctl_128.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_ctl_64.v \
  $QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_datapath.v \
  $QSYS_SIMDIR/submodules/altpcierd_compliance_test.v \
  $QSYS_SIMDIR/submodules/altpcierd_cpld_rx_buffer.v \
  $QSYS_SIMDIR/submodules/altpcierd_cplerr_lmi.v \
  $QSYS_SIMDIR/submodules/altpcierd_dma_descriptor.v \
  $QSYS_SIMDIR/submodules/altpcierd_dma_dt.v \
  $QSYS_SIMDIR/submodules/altpcierd_dma_prg_reg.v \
  $QSYS_SIMDIR/submodules/altpcierd_example_app_chaining.v \
  $QSYS_SIMDIR/submodules/altpcierd_npcred_monitor.v \
  $QSYS_SIMDIR/submodules/altpcierd_pcie_reconfig_initiator.v \
  $QSYS_SIMDIR/submodules/altpcierd_rc_slave.v \
  $QSYS_SIMDIR/submodules/altpcierd_read_dma_requester.v \
  $QSYS_SIMDIR/submodules/altpcierd_read_dma_requester_128.v \
  $QSYS_SIMDIR/submodules/altpcierd_reconfig_clk_pll.v \
  $QSYS_SIMDIR/submodules/altpcierd_reg_access.v \
  $QSYS_SIMDIR/submodules/altpcierd_rxtx_downstream_intf.v \
  $QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_ctl_fifo.v \
  $QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_data_fifo.v \
  $QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_fifo.v \
  $QSYS_SIMDIR/submodules/altpcierd_write_dma_requester.v \
  $QSYS_SIMDIR/submodules/altpcierd_write_dma_requester_128.v \
  $QSYS_SIMDIR/pcie_de_gen1_x8_ast128.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
