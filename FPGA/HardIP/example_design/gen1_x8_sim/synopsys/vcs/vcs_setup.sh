...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_scfifo.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_sv_scfifo_ext.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_scfifo_sv.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_sv_gbfifo.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_tlp_inspector.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_tlp_inspector_trigger.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_hip_eq_dprio.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_hip_eq_bypass_ph3.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcietb_bfm_pipe_8to32.v \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_inspector.sv \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_monitor_sv_dlhip_sim.sv \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_tlp_inspector_monitor.sv \
  $QSYS_SIMDIR/altera_pcie_sv_hip_ast/altpcie_tlp_inspector_cseb.sv \
